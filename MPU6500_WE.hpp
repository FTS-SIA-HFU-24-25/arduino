...
typedef enum MPU9250_BW_WO_DLPF {
    ...
    MPU6050_BW_WO_DLPF_3600 = MPU9250_BW_WO_DLPF_3600,
    MPU6050_BW_WO_DLPF_8800 = MPU9250_BW_WO_DLPF_8800
} MPU9250_bw_wo_dlpf;
...
typedef enum MPU9250_DLPF {
    ...
    MPU6050_DLPF_0 = MPU9250_DLPF_0, 
    MPU6050_DLPF_1 = MPU9250_DLPF_1, 
    MPU6050_DLPF_2 = MPU9250_DLPF_2, 
    MPU6050_DLPF_3 = MPU9250_DLPF_3, 
    MPU6050_DLPF_4 = MPU9250_DLPF_4, 
    MPU6050_DLPF_5 = MPU9250_DLPF_5,
    MPU6050_DLPF_6 = MPU9250_DLPF_6, 
    MPU6050_DLPF_7 = MPU9250_DLPF_7
} MPU9250_dlpf;
...
typedef enum MPU9250_GYRO_RANGE {
    ...
    MPU6050_GYRO_RANGE_250  = MPU9250_GYRO_RANGE_250, 
    MPU6050_GYRO_RANGE_500  = MPU9250_GYRO_RANGE_500, 
    MPU6050_GYRO_RANGE_1000 = MPU9250_GYRO_RANGE_1000, 
    MPU6050_GYRO_RANGE_2000 = MPU9250_GYRO_RANGE_2000
} MPU9250_gyroRange;
...
typedef enum MPU9250_ACC_RANGE {
    ...
    MPU6050_ACC_RANGE_2G  = MPU9250_ACC_RANGE_2G,
    MPU6050_ACC_RANGE_4G  = MPU9250_ACC_RANGE_4G, 
    MPU6050_ACC_RANGE_8G  = MPU9250_ACC_RANGE_8G, 
    MPU6050_ACC_RANGE_16G = MPU9250_ACC_RANGE_16G
} MPU9250_accRange;
...
typedef enum MPU9250_LOW_PWR_ACC_ODR {
    ...
    MPU6050_LP_ACC_ODR_0_24  = MPU9250_LP_ACC_ODR_0_24,
    MPU6050_LP_ACC_ODR_0_49  = MPU9250_LP_ACC_ODR_0_49, 
    MPU6050_LP_ACC_ODR_0_98  = MPU9250_LP_ACC_ODR_0_98, 
    MPU6050_LP_ACC_ODR_1_95  = MPU9250_LP_ACC_ODR_1_95,
    MPU6050_LP_ACC_ODR_3_91  = MPU9250_LP_ACC_ODR_3_91, 
    MPU6050_LP_ACC_ODR_7_81  = MPU9250_LP_ACC_ODR_7_81, 
    MPU6050_LP_ACC_ODR_15_63 = MPU9250_LP_ACC_ODR_15_63, 
    MPU6050_LP_ACC_ODR_31_25 = MPU9250_LP_ACC_ODR_31_25,
    MPU6050_LP_ACC_ODR_62_5  = MPU9250_LP_ACC_ODR_62_5, 
    MPU6050_LP_ACC_ODR_125   = MPU9250_LP_ACC_ODR_125, 
    MPU6050_LP_ACC_ODR_250   = MPU9250_LP_ACC_ODR_250, 
    MPU6050_LP_ACC_ODR_500   = MPU9250_LP_ACC_ODR_500
} MPU9250_lpAccODR;
...
typedef enum MPU9250_INT_PIN_POL {
    ...
    MPU6050_ACT_HIGH = MPU9250_ACT_HIGH,
    MPU6050_ACT_LOW = MPU9250_ACT_LOW
} MPU9250_intPinPol;
...
typedef enum MPU9250_INT_TYPE {
    ...
    MPU6050_DATA_READY = MPU9250_DATA_READY,
    MPU6050_FIFO_OVF   = MPU9250_FIFO_OVF,
    MPU6050_WOM_INT    = MPU9250_WOM_INT
} MPU9250_intType;
...
typedef enum MPU9250_WOM_EN {
    ...
    MPU6050_WOM_DISABLE = MPU9250_WOM_DISABLE, 
    MPU6050_WOM_ENABLE  = MPU9250_WOM_ENABLE
} MPU9250_womEn;
...
typedef enum MPU9250_WOM_COMP {
    ...
    MPU6050_WOM_COMP_DISABLE = MPU9250_WOM_COMP_DISABLE, 
    MPU6050_WOM_COMP_ENABLE  = MPU9250_WOM_COMP_ENABLE
} MPU9250_womCompEn;
...
typedef enum MPU9250_XYZ_ENABLE {
    ...
    MPU6050_ENABLE_XYZ = MPU9250_ENABLE_XYZ,  
    MPU6050_ENABLE_XY0 = MPU9250_ENABLE_XY0,  
    MPU6050_ENABLE_X0Z = MPU9250_ENABLE_X0Z,
    MPU6050_ENABLE_X00 = MPU9250_ENABLE_X00,
    MPU6050_ENABLE_0YZ = MPU9250_ENABLE_0YZ,
    MPU6050_ENABLE_0Y0 = MPU9250_ENABLE_0Y0,
    MPU6050_ENABLE_00Z = MPU9250_ENABLE_00Z,
    MPU6050_ENABLE_000 = MPU9250_ENABLE_000     
} MPU9250_xyzEn;
...
typedef enum MPU9250_ORIENTATION {
    ...
    MPU6050_FLAT   = MPU9250_FLAT, 
    MPU6050_FLAT_1 = MPU9250_FLAT_1, 
    MPU6050_XY     = MPU9250_XY,
    MPU6050_XY_1   = MPU9250_XY_1, 
    MPU6050_YX     = MPU9250_YX, 
    MPU6050_YX_1   = MPU9250_YX_1
} MPU9250_orientation;
...
typedef enum MPU9250_FIFO_MODE {
    ...
    MPU6050_CONTINUOUS     = MPU9250_CONTINUOUS, 
    MPU6050_STOP_WHEN_FULL = MPU9250_STOP_WHEN_FULL
} MPU9250_fifoMode;
...
typedef enum MPU9250_FIFO_TYPE {
    ...
    MPU6050_FIFO_ACC     = MPU9250_FIFO_ACC,
    MPU6050_FIFO_GYR     = MPU9250_FIFO_GYR,
    MPU6050_FIFO_ACC_GYR = MPU9250_FIFO_ACC_GYR
} MPU9250_fifo_type;
